...
export default function Page() {
  ...
  return (
    <main className="flex min-h-screen max-h-screen overflow-hidden bg-zinc-900 flex-row">
      ...
      <div className="flex-1 w-full max-h-screen overflow-hidden flex flex-col justify-center items-center">
        ...
        <div
          ...
          className="flex-grow h-full overflow-y-auto flex flex-col p-3 w-full items-center"
        >
          {loadingData && (
          ...
          {!loadingData && chatHistory.length === 0 && (
            <div className="grow flex flex-col gap-3 justify-center items-center text-zinc-500 my-3">
              ...
              {userInfo?.username && (
                <p>
                  Welcome <span className="font-bold">{userInfo.username}</span>
                </p>
              )}
            </div>
          )}
          ...
          {!loadingData && chatHistory.length > 0 && (
            <div className="grow w-full md:max-w-3xl flex flex-col gap-5 pb-10 ">
        ...
        <div className="w-full md:max-w-4xl">
          ...
          >
            ...
            {!loadingResponse && (
              <button type="submit" className="bg-zinc-800  rounded-xl">
                <Image
                  src="/icons/send.svg"
                  width={24}
                  height={24}
